...
public final class Complex {
	...
	public Complex add(Complex c) {
		...
		double newi = this.imaginary+ c.imaginary;
	...
	public Complex multiply(Complex c) {
		...
		double newr = this.real * c.real - this.imaginary * c.imaginary;
		double newi = this.real * c.imaginary + this.imaginary * c.real;
		return new Complex(newr,newi);
	}
	...
	@Override
	public int hashCode() {
		int result = (int)(9999*this.real+99*this.imaginary);
		return result;
	}
	...
	public String toString() {
		...
		if(this.imaginary >=0)
		{
			...
			result = this.real + " - " + Math.abs(this.imaginary)+"i";
		return result;
	}
	...
	public static Complex valueOf(String s) {
		...
		if(parts.size() != 3)
			...
			if(parts.get(1).equals("+")) {
				double im = Double.valueOf(parts.get(2).substring(0, parts.get(2).length()-1));
